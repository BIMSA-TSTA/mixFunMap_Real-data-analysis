...
# (simplified reproduction script for the mixFunMap manuscript).
#
# Two parts:
...
#      Compact versions of real_data_analysis/run_fip1_cc_lop_gwas.R
...
# ---------------------------------------------------------------------------
# BIC inset: simplified LOP degree selection mini plot embedded in panel a
