...
# analysis (simplified reproduction script for the mixFunMap manuscript).
#
# Two parts:
...
#      joint two-environment 3-df parameter G x E scan. Compact versions
#      of ril/scripts/run_lowwater_logistic_three_methods.R and
