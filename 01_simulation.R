...
# 01_simulation.R — formal V15 logistic simulation (simplified reproduction
...
#      cells x 200 replicates = 17,200 datasets. Compact reimplementation
#      of Fig/run_all_simulations_v15.R (01_simulate_logistic.R +
#      04_mixfunmap_adapter.R + 05_logistic_benchmark.R +
#      07_summarise_results.R): same design, models and estimators; the
#      checkpoint/chunk/audit layers are removed.
