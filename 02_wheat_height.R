...
# 02_wheat_height.R — FIP1 wheat FPWW012 plant-height GWAS (simplified
# reproduction script for the mixFunMap manuscript).
#
# Two parts:
#   1. Analysis (mode = "full"): reruns the three-method genome-wide scan
#      from the analysis-ready inputs in inputs/wheat_height/. This is the
#      compact version of real_data_analysis/run_fip1_height_gwas.R (all
#      checkpointing, logging and audit layers removed; model and numerics
#      unchanged).
