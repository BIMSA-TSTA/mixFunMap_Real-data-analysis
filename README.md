...
├── 04_rice_ril.R              # Rice RIL two-environment analysis (Figure 4)
...
│   ├── rice_ril/              #   RiceCGM/RDP1 two-environment joint inputs
...
│   ├── rice_ril/              #   control / lowwater / gxe and benchmark subdirs
